<div class="cashier-addsupplier-area bg-white p-7 custom-shadow rounded-lg pt-5 mb-5">
    <h4 class="text-[20px] font-bold text-heading mb-9" style="text-align:center">Issue Stock</h4>
    <form action="update-issue-product" method="post">
        <input type="hidden" value="<?php echo $data['stocks']->id;?>" name="id">
        <input type="hidden" value="<?php echo $data['stocks']->PqId;?>" name="pqid">
        <div class="grid grid-cols-12 gap-x-5">
                ...
                <div class="cashier-select-field mb-5">
                    ...
                    <div class="cashier-select-field-style">
                        <select class="block" name="tunnel" >
                            ...
                            ?> 
                            <option <?php if($data['stocks']->tunnel_id==$t->id){echo "selected";}?> value="<?php echo $t->id?>"><?=$t->TName;?></option>
                ...
                <div class="cashier-select-field mb-5">
                    ...
                    <div class="cashier-select-field-style">
                        <select class="block" name="person">
                            ...
                            ?> 
                            <option <?php if($data['stocks']->empoyee_id==$e->id){echo "selected";}?> value="<?php echo $e->id?>"><?=$e->Name;?></option>
                            <?php endforeach; endif;?>
                        </select>
                ...
                <div class="cashier-select-field mb-5">
                    ...
                    <div class="cashier-input-field-style">
                        <div class="single-input-field w-full">
                            <input type="date" name="issueDate"  value="<?php echo $data['stocks']->i_date; ?>"  id="issue--val">
                ...
                <div class="cashier-select-field mb-5">
                    ...
                    <div class="cashier-select-field-style">
                        <select class="block" name="product"  id="issue-stock-product-with-price">
                            ...
                            ?> 
                            <option <?php if($data['stocks']->pid==$p->id){echo "selected";}?> value="<?php echo $p->id?>"><?=$p->Name;?></option>
                            <?php endforeach; endif;?>
                        </select>
            ...
            <div class="lg:col-span-4 md:col-span-6 col-span-12">
                <div class="cashier-select-field mb-5">
                    ...
                    <div class="cashier-input-field-style">
                        <div class="single-input-field w-full">
                            <input type="text" name="qty" onkeyup="checkQty(this)"  value="<?php echo $data['stocks']->Quantity; ?>" >
            ...
            <div class="col-span-12">
                <div class="cashier-managesale-top-btn default-light-theme pt-2.5">
                    <button class="btn-primary" id="issue-stock-btn" type="submit">Update  Now</button>
                </div>
            </div>
        </div>
    </form>
