<div class="cashier-addsupplier-area bg-white p-7 custom-shadow rounded-lg pt-5 mb-5">
    ...
    <form action="asset/update" method="post">
        <input type="hidden" name="id" value="<?php echo $data['asset']->id;?>">
    <div class="grid grid-cols-12 gap-x-5" style="align-items: center;">
            ...
            <div class="cashier-select-field mb-5">
                ...
                <div class="cashier-input-field-style">
                    <div class="single-input-field w-full">
                        <input type="text" placeholder="" name="name" value="<?php echo $data['asset']->asset?>">
                        <?php validator('name')?>
                    </div>
                </div>
            </div>
        ...
        <div class="lg:col-span-6 md:col-span-6 col-span-12">
            <div class="cashier-select-field mb-5">
                ...
                <div class="cashier-input-field-style">
                    <div class="single-input-field w-full">
                        <input type="number" min='0' placeholder="" name="area" value="<?php echo $data['asset']->cost?>">
                        <?php validator('area')?>
                    </div>
                </div>
            </div>
        ...
        <?php
        $shares = explode(',', $data['asset']->share_id);
        $sHolder = explode(',', $data['asset']->sh_id);
            // Loop through each quantity and tunnel value to create individual records
            foreach ($shares as $index => $share_):
        ?>
            ...
            <div class="cashier-select-field mb-5">
                ...
                <div class="cashier-select-field-style">
                    <select class="block" style="display: none;" name="shareholder[]">
                        ...
                        <option <?php if($sHolder[$index]==$supplier->id){echo "selected";}?> value="<?php ShowVal($supplier->id);?>"><?php ShowVal($supplier->Name);?></option>
        ...
        <div class="lg:col-span-5 md:col-span-6 col-span-12">
            <div class="cashier-select-field mb-5">
                ...
                <div class="cashier-input-field-style">
                    <div class="single-input-field w-full">
                        <input type="number" min="0" placeholder="" name="shares[]" value="<?php echo $share_;?>">
