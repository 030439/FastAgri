...
$route['direct/create'] = 'directparty/add';
$route['direct/save'] = 'directparty/create';
$route['direct/list']="directparty/listing";
$route['direct/edit/(:num)']="directparty/directEdit/$1";
$route['direct/update']="directparty/updateDirect";
$route['direct/detail/(:num)']='directparty/customerDetail/$1';
$route['direct/customerDetailListing/(:num)']="directparty/directIssueStockJs/$1";
$route['getDirects']="directparty/getDirects";
$route['direct/ledger/(:num)']="directparty/customerLedger/$1";
$route['direct/ledger/list/(:num)']="directparty/customerLedgerList/$1";
//supplier
...
$route['direct-issue-product']="Stock/dirextIssueProduct";
