<div class="cashier-salereturns-area bg-white p-7 custom-shadow rounded-lg pt-5 mb-5">
    ...
    <div class="cashier-salereturns-table-area">
        <div class="cashier-salereturns-table-innerD">
            <div class="cashier-salereturns-table-inner-wrapperD border border-solid border-grayBorder border-b-0 mb-7">
                ...
                <div class="grid grid-cols-12">
                    <div class="lg:col-span-3 md:col-span-6 col-span-12">
                        <div
                            ...
                            <figure class="text-[14px] font-normal text-gray mr-1.5">Rows per page :
                            </figure>
