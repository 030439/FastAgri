<div class="cashier-content-area mt-[30px] px-7">
    <div class="cashier-managesale-area bg-white p-7 pt-5 custom-shadow rounded-lg mb-5">
        <div class="cashier-managesale-top-btn default-light-theme mb-7">
            <button class="mb-1" onclick="document.location='stock/direct'">
                <i class="fa-light fa-plus"></i> Direct Issue Stock
            </button>
            <h4 class="text-[20px] font-bold text-heading" style="text-align:center;width:70%">Direct Issue Stock  List</h4>
...
<?php $file="issue-stock-list-direct.php";?>