<div class="cashier-addsupplier-area bg-white p-7 custom-shadow rounded-lg pt-5 mb-5">
    <h4 class="text-[20px] font-bold text-heading mb-9">Update Employee Advance Cashbook Entry</h4>
    <form action="update-cashbook-pay" method="POST">
    <input type="hidden" name="record" value="advance">
            ...
            <div class="lg:col-span-4 md:col-span-6 col-span-12">
                <div class="cashier-select-field mb-5">
                    ...
                    <div class="cashier-select-field-style">
                        ...
                        <option <?php is_qual($employee->id,$data['record'][0]['cash_sP']); echo " "; set_values($employee->id);?>><?php echo $employee->Name;?></option>
                        <?php endforeach;?>
                        </select>
