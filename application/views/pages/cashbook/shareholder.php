<div class="cashier-addsupplier-area bg-white p-7 custom-shadow rounded-lg pt-5 mb-5">
    <h4 class="text-[20px] font-bold text-heading mb-9">Update ShareHolder Cash In  Cashbook Entry</h4>
    <form action="update-cashbook-pay" method="POST">
    <input type="hidden" name="record" value="shareholder">
    <input type="hidden" name="id" value="<?php echo $data['record'][0]['id'];?>">
        ...
        <div class="lg:col-span-4 md:col-span-6 col-span-12">
            <div class="cashier-select-field mb-5">
                ...
                <div class="cashier-input-field-style">
                    <div class="single-input-field w-full">
                        <input type="number" name="amount" placeholder="amount" <?php set_values($data['record'][0]['amount']);?>>
