<div class="cashier-addsupplier-area bg-white p-7 custom-shadow rounded-lg pt-5 mb-5">
    <h4 class="text-[20px] font-bold text-heading mb-9">Update Supplier Cashbook Entry</h4>
    <form action="update-cashbook-pay" method="POST">
    <div class="grid grid-cols-12 gap-x-5">
    <input type="hidden" name="record" value="supplier">
                ...
                <div class="cashier-select-field mb-5">
                    ...
                    <div class="cashier-select-field-style">
                        <select id="cash-selection-party" class="block" name="cash-selection-party">
                            <?php foreach($data['suplliers'] as $supllier):?>
                            <option <?php is_qual($supllier->id,$data['record'][0]['cash_sP']); echo " "; set_values($supllier->id);?>><?php echo $supllier->Name;?></option>
                            <?php endforeach;?>
                            </select>
