<div class="cashier-addsupplier-area bg-white p-7 custom-shadow rounded-lg pt-5 mb-5">
    <h4 class="text-[20px] font-bold text-heading mb-9">Update product </h4>
                    ...
                    <div class="cashier-input-field-style">
                        ...
                        <select class="block single-input-field w-full" name="unit_id" >
                            ...
                            <?php 
                                ...
                                foreach($data as $d):    
                            ?>
                            <option  <?php if($product->unit_id){echo "selected";}?> value="<?php echo $d->id?>"><?php echo $d->Name?></option>
                            <?php 
                                endforeach;
                                endif;
                            ?>
