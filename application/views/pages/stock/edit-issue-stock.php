                ...
                <div class="cashier-select-field mb-5">
                    ...
                    <div class="cashier-select-field-style">
                        <select class="block" name="person">
                            ...
                            ?> 
                            <option <?php if($data['stocks']->empoyee_id==$t->id){echo "selected";}?> value="<?php echo $e->id?>"><?=$e->Name;?></option>
                            <?php endforeach; endif;?>
                        </select>
                ...
                <div class="cashier-select-field mb-5">
                    ...
                    <div class="cashier-select-field-style">
                        <select class="block" name="product"  id="issue-stock-product-with-price">
                            ...
                            ?> 
                            <option <?php if($data['stocks']->pid==$t->id){echo "selected";}?> value="<?php echo $p->id?>"><?=$p->Name;?></option>
                            <?php endforeach; endif;?>
                        </select>
