           ...
           "columns": [
            ...
            { 
                ...
                "render": function(data, type, row) {
                    ...
                    return '<button  onclick="handleButtonClick(\'' + row.id + '\')" class="btn-design btn-exp">Expense</button>'+
                    '<button  onclick="profitButtonClick(\'' + row.id + '\')" class="btn-design btn-detail">Profit</button>'+
                    ...
                    '<button  onclick="editButtonClick(\'' + row.id + '\')" class="btn-design btn-edit">Edit</button>'+
