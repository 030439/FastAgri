...
$newRecord['Labour'] = number_format( $Labour[0]*$newRecord['Quantity'],2);
$newRecord['commission'] = number_format($commission[0]*$newRecord['Quantity'],2);
$newRecord['fre'] =  $fre[0]*$newRecord['Quantity'];
                $newRecord['amount'] = $amounts[$i] ?? $amounts[0];
